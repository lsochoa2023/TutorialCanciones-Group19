...
class App(QApplication):
    ...
    def mostrar_ventana_album(self, indice_album):
        ...
        self.ventana_album.mostrar_canciones(
            self.logica.dar_canciones_de_album(indice_album)
        )
    ...
    def mostrar_ventana_cancion(self, nueva=False, id_album=-1, id_cancion=-1):
        ...
        if not nueva:
            cancion = self.logica.dar_cancion_por_id(
                self.ventana_cancion.cancion_actual["id"]
                if id_cancion == -1
                else id_cancion
            )
    ...
    def guardar_album(self, n_album, nuevo_album):
        ...
        """
        guardar_album = self.logica.editar_album(
            n_album,
            nuevo_album["titulo"],
            nuevo_album["ano"],
        ...
        if guardar_album is False:
            ...
            mensaje_error.setText(
                "Ya existe un album con el título " + nuevo_album["titulo"]
            )
    ...
    def guardar_cancion(self, nueva_cancion, interpretes):
        ...
        res = self.logica.editar_cancion(
            ...
            nueva_cancion["segundos"],
            nueva_cancion["compositor"],
            interpretes,
        )
    ...
    def crear_album(self, nuevo_album):
        ...
        """
        crear_album = self.logica.agregar_album(
            nuevo_album["titulo"],
            nuevo_album["ano"],
            nuevo_album["descripcion"],
            nuevo_album["medio"],
    ...
    def crear_cancion(self, nueva_cancion, interpretes, id_album=-1):
        ...
        if (
            ...
            if (
                int(nueva_cancion["minutos"]) == 0
                and int(nueva_cancion["segundos"]) < 10
            ):
                mensaje_error = QMessageBox()
                mensaje_error.setIcon(QMessageBox.Critical)
                mensaje_error.setWindowTitle("Error al guardar canción")
                ...
                if id_album == -1:
                    ...
                    operacion = self.logica.agregar_cancion(
                        nueva_cancion["titulo"],
                        nueva_cancion["minutos"],
                        nueva_cancion["segundos"],
                        nueva_cancion["compositor"],
    ...
    def asociar_cancion(self, id_album, id_cancion):
        ...
        self.ventana_album.mostrar_canciones(
            self.logica.dar_canciones_de_album(id_album)
        )
