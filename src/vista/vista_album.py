...
class VentanaAlbum(QWidget):
    ...
    def mostrar_dialogo_agregar_cancion(self):
        ...
        caja_botones.layout().addWidget(
            but_aceptar, 0, 0, QtCore.Qt.AlignTop | QtCore.Qt.AlignCenter
        )
        caja_botones.layout().addWidget(
            but_cancelar, 0, 1, QtCore.Qt.AlignTop | QtCore.Qt.AlignCenter
        )
        ...
        but_cancelar.clicked.connect(lambda: self.dialogo_agregar_cancion.close())
